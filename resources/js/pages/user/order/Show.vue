    ...
    <UserLayout>
        <div class="min-h-screen bg-gray-50 py-8">
            <div class="mx-auto max-w-md px-4">
                <div v-if="pageErrors && pageErrors.status" class="relative mb-4 rounded border border-red-400 bg-red-100 px-4 py-3 text-red-700">
                    <strong class="font-bold">Error!</strong>
                    <span class="block sm:inline">{{ pageErrors.status[0] }}</span>
                </div>
                <!-- Back Button & Header -->
                <div v-if="!pageErrors || !pageErrors.status">
                        ...
                        <div class="space-y-4">
                            ...
                            >
                                ...
                                <div class="flex-shrink-0 text-right">
                                    <span
                                        :class="getItemStatusClass(item.is_done)"
...
const pageErrors = computed(() => page.props.errors as unknown as Record<string, string[]> | null);
